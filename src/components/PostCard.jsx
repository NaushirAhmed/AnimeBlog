...
const PostCard = ({ id, image, category, title, excerpt, author, date }) => {
  return (
    <Link to={`/post/${id}`} className="block bg-[#1A1A2A] rounded-2xl overflow-hidden border border-white/5 hover:border-[#C235EA]/40 transition-colors group">
      ...
      <div className="p-4">
        ...
        <p className="text-gray-400 text-xs mt-2 line-clamp-2">{excerpt}</p>
